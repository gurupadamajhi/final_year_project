...
image = cv2.imread('brain side.jpg', cv2.IMREAD_GRAYSCALE)
...
# Function to reverse permute blocks"""
...
cv2.imwrite('encrypted_image_mt1.png', encrypted_image_mt)
cv2.imwrite('encrypted_image_dsmft1.png', encrypted_image_dsmft)
cv2.imwrite('encrypted_image_mrg1.png', encrypted_image_mrg)
cv2.imwrite('encrypted_image_mlfg1.png', encrypted_image_mlfg)
...
#cv2.imwrite('encrypted_mt.png', encrypted_image_mt)
#cv2.imwrite('encrypted_dsmft.png', encrypted_image_dsmft)
#cv2.imwrite('encrypted_mrg.png', encrypted_image_mrg)
#cv2.imwrite('encrypted_mlfg.png', encrypted_image_mlfg)
...
calculate_test(gray_image=image, 
               encrypted_image=encrypted_image_mt, 
               decrypted_image=decrypted_image_mt)


calculate_test(gray_image=image, 
               encrypted_image=encrypted_image_dsmft, 
               decrypted_image=decrypted_image_dsmft)


calculate_test(gray_image=image, 
               encrypted_image=encrypted_image_mrg, 
               decrypted_image=decrypted_image_mrg)


calculate_test(gray_image=image, 
               encrypted_image=encrypted_image_mlfg, 
               decrypted_image=decrypted_image_mlfg)
